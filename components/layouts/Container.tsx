  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center sticky justify-between w-full max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pt-4 pb-4 sm:pb-8  text-gray-900 bg-gray-50  dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
