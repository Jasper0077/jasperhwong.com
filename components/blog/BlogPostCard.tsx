...
const BlogPostCard = (props: CardProps) => {
  ...
  return (
    <a
      ...
      className="flex flex-col items-center p-6 max-w-2xl bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
    >
