...
const BlogPostCard = (props: CardProps) => {
  ...
  return (
    <motion.div
      className={cn(
        "flex flex-col items-start min-h-min p-6 max-w-2xl",
        "bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700",
        "cursor-pointer"
      )}
      variants={fadeIn({
        direction: "right",
