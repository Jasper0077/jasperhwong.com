    ...
    <div className={props.className}>
      ...
      <div className="mt-2">
        <input
          ...
          id={props.label}
          className={cn([
            "block w-full rounded-md border-0 p-2 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:ring-gray-900",
            "bg-neutral-200 text-gray-900 placeholder:text-gray-400",
            "placeholder:text-gray-400 dark:bg-gray-200 dark:text-gray-900"
          ])}
